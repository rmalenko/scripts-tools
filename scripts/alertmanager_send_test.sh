...
curl -XPOST -d"$alerts1" http://1.2.3.4:9093/api/v1/alerts
curl -XPOST -d"$alerts1" http://1.2.3.4:9094/api/v1/alerts
curl -XPOST -d"$alerts1" http://1.2.3.4:9095/api/v1/alerts
